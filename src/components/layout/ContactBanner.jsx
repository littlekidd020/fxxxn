  ...
  return (
    <motion.div 
       ...
       animate={{ y: 0, opacity: 1 }}
        className={`relative z-20 w-full bg-emerald text-noir overflow-hidden shadow-[0_-15px_40px_rgba(184,134,11,0.15)] border-t border-gold/30 border-b border-emerald/50 mt-auto ${shouldHideOnMobile ? 'hidden md:block' : 'block'}`}
    >
      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-4 md:py-0 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-3 md:h-[70px]">
        ...
        <div className="flex justify-center items-center gap-3 shrink-0">
           <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-noir flex items-center justify-center shadow-[0_0_15px_rgba(0,0,0,0.4)] p-1 relative overflow-hidden shrink-0">
        ...
        <div className="hidden md:flex flex-col text-center md:text-right justify-center shrink-0 md:pl-4 mb-4 md:mb-0">
           <p className="text-[10px] md:text-xl font-black tracking-[0.3em] md:tracking-[0.5em] leading-none mb-1.5 drop-shadow-md text-noir/90">
