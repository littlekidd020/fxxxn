        ...
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          {images.length > 1 && (
            <button
              ...
              className="absolute left-0 z-[110] p-4 bg-white/5 hover:bg-[#568249] rounded-full text-white transition-all border border-white/10 hidden md:block"
            >
              <ChevronLeft size={32} />
            </button>
          )}
          ...
          {images.length > 1 && (
            <button
              ...
              className="absolute right-0 z-[110] p-4 bg-white/5 hover:bg-[#568249] rounded-full text-white transition-all border border-white/10 hidden md:block"
            >
